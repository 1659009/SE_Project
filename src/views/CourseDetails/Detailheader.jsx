        ...
        <Grid container className="headerDescription" spacing={1}>
          <Grid item className="listItemLeft" xs={6}>
            <Breadcrumbs
              ...
              <Typography className="previousPath">Advanced Courses</Typography>
            </Breadcrumbs>
            <br />
            <div className="courseInformation">
              ...
              <p className="courseShortDescription">
                ...
                exercitationem tempora, recusandae similique saepe soluta
                veniam, eveniet nulla ab id nobis, incidunt deleniti quod minima
                dicta quos officia optio! Culpa?
              </p>
            </div>
          ...
          <Grid item className="listItemRight" xs={6}>
            ...
            <img className="courseProviderLogo" src="https://www.sisk.ie/sites/default/files/slideshow/395/930-958-origo-logo.png" alt="course logo"/>
          </Grid>
        </Grid>
      </div>
    );
